        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-3 group cursor-pointer text-gray-500">
                ...
                <span className="group-hover:text-gray-800">cskh@xanh.vn</span>
              </li>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex flex-wrap gap-2 uppercase font-bold text-[10px]">
                <span className="px-2 py-1 border rounded bg-white shadow-sm">VNPAY</span>
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm space-y-3 leading-relaxed">
              <p className="font-bold text-gray-800">CÔNG TY CỔ PHẦN XANH HOTEL VIỆT NAM</p>
        ...
        <div className="border-t mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-xs text-gray-400 text-center md:text-left">
              <p>© 2026 XANH HOTEL Vietnam, Jsc. All rights reserved.</p>
